...
function Contact() {
	return (
		...
		>
			...
			<div className='flex flex-wrap gap-12 justify-center items-center m-6 bg-contact text-contact-foreground h-64 p-6 rounded-lg'>
				{
					user.contacts.map((contact: IContact, index) =>
						<div className='min-h-16 min-w-16  p-2 flex flex-col justify-center items-center rounded-lg' >
							{
